...
def make_npy_by_video_FFpp_x_DFDC(infile, out_dir, timesteps=5, overlap=0):
...
if __name__ == '__main__':
    DATA_ROOT = r'/data/PROJECT FILES/DFD_Embeddings/FFpp_embeddings/cross/DFDC'

    # clean_raw_csv(infile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings.csv'),
    #               outfile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_cleaned.csv'))

    # make_short_file(infile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_cleaned.csv'),
    #                 outfile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_cleaned_short.csv'),
    #                 use_pandas=True,
    #                 sample_size=500)

    # save_predictions_only(infile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_cleaned.csv'),
    #                       outfile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_predictions.csv'))

    # correct_filename_column(infile = os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_predictions.csv'),
    #                         outfile = os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_folders_count.csv'))

    # evaluate_ViT(infile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_predictions.csv'))

    make_npy_by_video_FFpp_x_DFDC(infile=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_test_embeddings_cleaned.csv'),
                                  out_dir=os.path.join(DATA_ROOT, 'FFpp_x_DFDC_npy_videos_5steps_overlap'),
                                  timesteps=5,
                                  overlap=4)